const products = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1496181130204-755241524eab?w=800',
    description:
  ...
  },
  {
    ...
    description:
      'With two processors controlling eight microphones, Auto NC Optimizer for automatically optimizing noise canceling based on your wearing conditions and environment, and a specially designed driver unit, WH-1000XM5 headphones rewrite the rules for distraction-free listening and exceptional call clarity.',
    brand: 'SONY',
    category: 'Audio',
    price: 29990,
    countInStock: 12,
  ...
  {
    name: 'Apple iPhone 15 Pro Max (256 GB) - Titanium Gray',
  ...
  },
  {
    ...
    description:
      'G502 is an icon, topping the charts through every generation, and the mouse of choice for serious gamers. Now, G502 joins the ranks of the world’s most advanced wireless gaming mice with the release of G502 LIGHTSPEED. ULTRA-FAST 1ms wireless performance, HERO 25K sensor.',
    brand: 'LOGITECH',
  ...
  },
  {
    ...
    description:
      'Blow your opponents away with the Razer BlackWidow V4 Pro mechanical gaming keyboard. It features Razer Green Clicky Mechanical Switches for precise actuation with a tactile feel, 2-side underglow and per-key RGB, and a dedicated multi-function dial.',
    brand: 'RAZER',
    category: 'Gaming Accessories',
    price: 21999,
    countInStock: 15,
  ...
  {
    name: 'Samsung 49" Odyssey G9 Dual QHD Curved Gaming Monitor',
    image: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=800',
    description:
      'Immerse yourself in the game with the Samsung 49" Odyssey G9. Featuring a 1000R curved screen, dual QHD resolution, 240Hz refresh rate, 1ms response time, and fully customizable Infinity Core lighting, it delivers unmatched gaming realism.',
    brand: 'SAMSUNG',
    category: 'Electronics',
    price: 145000,
    countInStock: 4,
