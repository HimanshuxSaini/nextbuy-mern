...
const resetPasswordRequest = async (req, res, next) => {
  try {
    ...
    const passwordResetLink = `${frontendUrl}/reset-password/${user._id}/${token}`;
    ...
    try {
      const mailResponse = await transporter.sendMail({
        ...
        to: user.email,
        subject: 'Password Reset - NextBuy',
    ...
    res
      ...
      .json({ 
        ...
        link: process.env.NODE_ENV === 'development' ? passwordResetLink : undefined
      });
  } catch (error) {
    next(error);
  }
